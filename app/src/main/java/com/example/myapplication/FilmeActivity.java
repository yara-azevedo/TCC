...
public class FilmeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        find();
        pageTitleTextView.setText("Filmes");
        setupRecyclerView();
    ...
    void selectFiltro(){
        ...
        linear_count_jogo.setOnClickListener(view ->
                startActivity(new Intent(FilmeActivity.this, JogoActivity.class)));

        linear_count_livro.setOnClickListener(view ->
                startActivity(new Intent(FilmeActivity.this, LivroActivity.class)));
    }
