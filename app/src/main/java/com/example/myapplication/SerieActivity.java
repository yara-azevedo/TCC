...
public class SerieActivity extends AppCompatActivity {
    ...
    void selectFiltro(){
        linear_count_filme.setOnClickListener(view ->
                startActivity(new Intent(SerieActivity.this, FilmeActivity.class)));


        linear_count_jogo.setOnClickListener(view ->
                startActivity(new Intent(SerieActivity.this, JogoActivity.class)));

        linear_count_livro.setOnClickListener(view ->
                startActivity(new Intent(SerieActivity.this, LivroActivity.class)));
    }
