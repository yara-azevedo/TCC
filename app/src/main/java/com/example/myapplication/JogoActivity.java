...
public class JogoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        find();
        pageTitleTextView.setText("Jogos");
        setupRecyclerView();
    ...
    void selectFiltro(){
        linear_count_filme.setOnClickListener(view ->
                startActivity(new Intent(JogoActivity.this, FilmeActivity.class)));

        linear_count_serie.setOnClickListener(view ->
                startActivity(new Intent(JogoActivity.this, SerieActivity.class)));

        linear_count_livro.setOnClickListener(view ->
                startActivity(new Intent(JogoActivity.this, LivroActivity.class)));
    }
